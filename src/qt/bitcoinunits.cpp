...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("RajmudraCoins"));
    case mBTC: return QString(QObject::tr("Milli-RajmudraCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-RajmudraCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
